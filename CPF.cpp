...
printf ("Digite o primeiro digito do seu CPF: ");
scanf ("%d", &n1);	
	
printf ("Digite o segundo digito do seu CPF: ");
scanf ("%d", &n2);	
	
printf ("Digite o terceiro digito do seu CPF: ");
scanf ("%d", &n3);	
	
printf ("Digite o quarto digito do seu CPF: ");
scanf ("%d", &n4);	
	
printf ("Digite o quinto digito do seu CPF: ");
scanf ("%d", &n5);	
	
printf ("Digite o sexto digito do seu CPF: ");
scanf ("%d", &n6);

printf ("Digite o setimo digito do seu CPF: ");
scanf ("%d", &n7);	

printf ("Digite o oitavo digito do seu CPF: ");
scanf ("%d", &n8);	

printf ("Digite o nono digito do seu CPF: ");
scanf ("%d", &n9);		

//Atribui��o das fun��es
